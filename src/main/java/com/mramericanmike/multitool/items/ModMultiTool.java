package com.mramericanmike.multitool.items;
...
public class ModMultiTool extends DiggerItem {
	...
	public ModMultiTool(Tier tier, float speed, float damage, Item.Properties properties) {
